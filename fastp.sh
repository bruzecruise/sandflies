...
do 
    fastp --thread ${THREAD} -q 20 -l 25 --in1 ../RAW_fastq/${FILE}_1.fastq.gz --in2 ../RAW_fastq/${FILE}_2.fastq.gz --out1 trim1.${FILE}_1.fq.gz --out2 trim1.${FILE}_2.fq.gz --adapter_fasta fastp_adapter.fasta -h ${FILE}.html; 
done
